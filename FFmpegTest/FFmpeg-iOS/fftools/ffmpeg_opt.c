...
static AVCodec *find_codec_or_die(const char *name, enum FFAVMediaType type, int encoder)
{
...
{
    enum FFAVMediaType type = ost->st->codecpar->codec_type;
    char *codec_name = NULL;
...
static OutputStream *new_output_stream(OptionsContext *o, AVFormatContext *oc, enum FFAVMediaType type, int source_index)
{
    OutputStream *ost;
...
static void check_streamcopy_filters(OptionsContext *o, AVFormatContext *oc,
                                     const OutputStream *ost, enum FFAVMediaType type)
{
    if (ost->filters_script || ost->filters) {
